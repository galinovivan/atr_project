...
<div class="helper red" id="topHelper">
    <span>Приём работ открыт с 1 апреля до 15 сентября 2017. ​Загрузить работу на конкурс можно <a href="<?=get_page_link(68);?>" data-toggle="modal"> здесь</a>.</span>
    ...
    <div class="container">
        ...
        <div class="row nav_header_section line_hover">
            ...
            <div class="col-md-12 nav_text">
                <div class="text">
                    <h3 class="text-center white">АРХпроект» — Всероссийский конкурс архитектурных и дизайнерских проектов, открытый для участия как студентам, так и молодым архитекторам.</h3>
                </div>
                <div class="cursor">
